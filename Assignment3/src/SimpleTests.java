...
public class SimpleTests {
	public static void main(String args[]) throws FileNotFoundException {
		...
		System.out.println("Width: " + grid.getWidth()); //pass
		System.out.println("Height: " + grid.getHeight()); //pass
		System.out.println("Tile: " + grid.getTile(0, 1)); // pass
		System.out.println(grid); //pass
		System.out.println();
